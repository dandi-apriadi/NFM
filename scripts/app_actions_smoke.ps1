...
# 1) Wallet transfer
$transferAmount = 1.25
$transferTarget = "nfm_smoke_receiver"
...
$proposalTitle = "Smoke Proposal $(Get-Date -Format 'yyyyMMdd-HHmmss')"
...
if ($endingProposals -lt ($startingProposals + 1)) {
    throw "Expected proposal count to increase (before=$startingProposals, after=$endingProposals)"
}
