...
impl LoadTestRunner {
    ...
    fn get_request_body(path: &str) -> String {
        match path {
            "/api/brain/route" => serde_json::json!({
                "requester_node_id": "load_tester",
                "user_latitude": -6.2088,
                "user_longitude": 106.8456,
                "data_class": "global",
                "critical": false
            }).to_string(),
            "/api/brain/benchmark" => serde_json::json!({
                "requester_node_id": "load_tester",
                "user_latitude": -6.2088,
                "user_longitude": 106.8456,
                "data_class": "global",
            ...
            "/api/transfer/create" => serde_json::json!({
                "from": "test_sender",
                "to": "test_receiver",
                "amount": 1.5
            }).to_string(),
    ...
    fn generate_report(&self, total_duration: Duration) -> LoadTestReport {
        ...
        let mut endpoint_map: HashMap<(String, String), Vec<f64>> = HashMap::new();
...
mod tests {
    ...
    #[test]
    fn test_request_metric_creation() {
